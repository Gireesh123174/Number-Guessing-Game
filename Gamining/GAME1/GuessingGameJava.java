...
public class GuessingGameJava implements ActionListener, KeyListener {
	...
	GuessingGameJava(){
		...
		UI.put("OptionPane.background",new Color(255,242,102));
		UI.put("Panel.background", new Color(255,242,102));
		...
		panel1.setBackground(new Color(52,255,255));
		panel1.setBounds(0,0,350,500);

		panel2=new JPanel();
		panel2.setLayout(null);
		panel2.setBackground(new Color(0,255,51));
		...
		textLabel2.setFont(new Font("Comic Sans MS", Font.BOLD, 35));
